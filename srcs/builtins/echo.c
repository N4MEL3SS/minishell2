...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/03/01 14:37:23 by ncallie           #+#    #+#             */
/*   Updated: 2022/03/01 14:37:25 by ncallie          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"

void	print_echo(t_mini_shell *in, int i)
{
	while (in->split_in[i])
	{
...
void	is_multiple_n(t_mini_shell *in, int i)
{
	i = 1;
	if (in->split_in[i + 1] == NULL)
		return ;
