...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/03/01 14:36:39 by ncallie           #+#    #+#             */
/*   Updated: 2022/03/01 15:10:47 by ncallie          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"

int	check_var_aux(t_mini_shell *in)
{
...
void	expand_vars_aux(t_mini_shell *in)
{
	int		check;
	char	*aux;
	char	*var;
