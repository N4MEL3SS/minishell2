...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/03/01 14:36:45 by ncallie           #+#    #+#             */
/*   Updated: 2022/03/01 14:44:44 by ncallie          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"

void	split_args_aux2(t_mini_shell *in, char **final_in, char c)
{
...
void	split_args_aux(t_mini_shell *in, char **final_in)
{
	char	c;
